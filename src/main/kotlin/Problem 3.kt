...
val isLongPrime = { n: Long -> (2..(n / 2)).none { divisor: Long -> isLongMultipleOf(divisor, n) } }
...
tailrec fun primeFactorize(n: Long, soFar: List<Long>): List<Long> {
    ...
    val primeDivisor = ((soFar.lastOrNull() ?: 2)..n).find(isLongPrime and isLongMultipleOf.reverse().curried()(n)) ?: 0
